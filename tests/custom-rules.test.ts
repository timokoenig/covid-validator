...
import { CustomRule, exportRule, Rule, validateDCCRule } from '../utils/certlogic'
...
const localRulesHamburg = customRule.rules.map(rule =>
  exportRule(rule, customRule.immunizationRules)
)
